...
function createWasm() {
    ...
    function receiveInstance(instance, module) {
        ...
        Module["asm"] = exports;
        wasmMemory = Module["asm"]["Xd"];
        updateGlobalBufferAndViews(wasmMemory.buffer);
        wasmTable = Module["asm"]["ae"];
        addOnInit(Module["asm"]["Yd"]);
...
var asmLibraryArg = {
    ...
    "Ta": __emscripten_date_now,
    "aa": _emscripten_get_element_css_size,
    "X": _emscripten_get_gamepad_status,
    "G": _emscripten_get_now,
    "Y": _emscripten_get_num_gamepads,
    "Jd": _emscripten_glActiveTexture,
    "Id": _emscripten_glAttachShader,
    "Q": _emscripten_glBeginQueryEXT,
    ...
    "S": _emscripten_glDeleteQueriesEXT,
    ...
    "$c": _emscripten_glDepthFunc,
    "_c": _emscripten_glDepthMask,
    "Zc": _emscripten_glDepthRangef,
    "Yc": _emscripten_glDetachShader,
    "Xc": _emscripten_glDisable,
    "Wc": _emscripten_glDisableVertexAttribArray,
    "Vc": _emscripten_glDrawArrays,
    "Md": _emscripten_glDrawArraysInstancedANGLE,
    "Nd": _emscripten_glDrawBuffersWEBGL,
    "Uc": _emscripten_glDrawElements,
    "Ld": _emscripten_glDrawElementsInstancedANGLE,
    "Tc": _emscripten_glEnable,
    "Sc": _emscripten_glEnableVertexAttribArray,
    "P": _emscripten_glEndQueryEXT,
    "Rc": _emscripten_glFinish,
    "Qc": _emscripten_glFlush,
    "Pc": _emscripten_glFramebufferRenderbuffer,
    "Oc": _emscripten_glFramebufferTexture2D,
    "Nc": _emscripten_glFrontFace,
    "Mc": _emscripten_glGenBuffers,
    "Kc": _emscripten_glGenFramebuffers,
    "T": _emscripten_glGenQueriesEXT,
    "Jc": _emscripten_glGenRenderbuffers,
    "Ic": _emscripten_glGenTextures,
    "Pd": _emscripten_glGenVertexArraysOES,
    "Lc": _emscripten_glGenerateMipmap,
    "Hc": _emscripten_glGetActiveAttrib,
    "Gc": _emscripten_glGetActiveUniform,
    "Fc": _emscripten_glGetAttachedShaders,
    "Ec": _emscripten_glGetAttribLocation,
    ...
    "O": _emscripten_glQueryCounterEXT,
    ...
    "gb": _emscripten_glUniformMatrix4fv,
    ...
    "$a": _emscripten_glVertexAttrib3f,
    "_a": _emscripten_glVertexAttrib3fv,
    ...
    "za": _emscripten_set_fullscreenchange_callback_on_thread,
    "ta": _emscripten_set_gamepadconnected_callback_on_thread,
    "sa": _emscripten_set_gamepaddisconnected_callback_on_thread,
    "Wd": _emscripten_set_main_loop,
    "ua": _emscripten_set_touchcancel_callback_on_thread,
    ...
    "W": _glUniform1i,
    "ba": _glUniform4f,
    "Ca": _glUniformMatrix4fv,
    "o": _glUseProgram,
    "f": _glVertexAttribPointer,
    "Vd": _glViewport,
    "v": _glfwCreateWindow,
    "pa": _glfwDefaultWindowHints,
    "$": _glfwDestroyWindow,
    "w": _glfwGetPrimaryMonitor,
    "c": _glfwGetTime,
    "oa": _glfwGetVideoModes,
    "qa": _glfwInit,
    "da": _glfwMakeContextCurrent,
    "ia": _glfwSetCharCallback,
    "ea": _glfwSetCursorEnterCallback,
    "ga": _glfwSetCursorPosCallback,
    "ka": _glfwSetDropCallback,
    "ra": _glfwSetErrorCallback,
    "ja": _glfwSetKeyCallback,
    "ha": _glfwSetMouseButtonCallback,
    "fa": _glfwSetScrollCallback,
    "la": _glfwSetWindowFocusCallback,
    "ma": _glfwSetWindowIconifyCallback,
    "V": _glfwSetWindowShouldClose,
...
var ___wasm_call_ctors = Module["___wasm_call_ctors"] = function () {
    return (___wasm_call_ctors = Module["___wasm_call_ctors"] = Module["asm"]["Yd"]).apply(null, arguments)
};
var _malloc = Module["_malloc"] = function () {
    return (_malloc = Module["_malloc"] = Module["asm"]["Zd"]).apply(null, arguments)
};
...
var ___errno_location = Module["___errno_location"] = function () {
    return (___errno_location = Module["___errno_location"] = Module["asm"]["be"]).apply(null, arguments)
};
var ___start_em_js = Module["___start_em_js"] = 27216;
var ___stop_em_js = Module["___stop_em_js"] = 27291;
var calledRun;
